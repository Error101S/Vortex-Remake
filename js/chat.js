(function () {
    ...
    function send() {
        ...
        window._mpSendChat?.(profanityCleaner.clean(text, { placeholder: '#' }));
        chatValue = '';
    ...
    window.Chat = { message, system, warn, open: openChat, close: closeChat, activate: activateChat, deactivate: deactivateChat, send };
})();
